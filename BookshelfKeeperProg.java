...
public class BookshelfKeeperProg {
   ...
   public static void invalidPickOutput() {
      System.out.println("ERROR: Entered pick operation is invalid on this shelf.");
      System.out.println("Exiting Program.");
   }

   public static void invalidPutOutput() {
      System.out.println("ERROR: Height of a book must be positive.");
      System.out.println("Exiting Program.");
   }
   ...
   public static void main(String[] args) {
      ...
      boolean valid = BookshelfKeeperProg.buildBookshelf(bookshelf);
      ...
      if (valid) {
         ...
         while (!end) {
            ...
            if (!methodTemp.equals("pick") && !methodTemp.equals("put") && !methodTemp.equals("end")) {
               BookshelfKeeperProg.invalidCommandOutput();
               end = true;
            }
               ...
               if (pickIndex < 0 || pickIndex >= bookshelfKeeper.getNumBooks()) {
                  BookshelfKeeperProg.invalidPickOutput();
                  end = true;
               }
               else {
               ...
               if (putIndex <= 0) {
                  BookshelfKeeperProg.invalidPutOutput();
                  end = true;
               }
               else {
